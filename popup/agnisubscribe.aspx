<%@ Page Language="C#" AutoEventWireup="true" CodeFile="agnisubscribe.aspx.cs" Inherits="popup_agnisubscribe" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12" style="background-color: #330B41; color: #fff; padding-bottom: 20px;">
                <h1 style="font-family: 'Spongeboy Me Bob';">AGNI Coming Soon</h1>
                <p>Agni is soon going to be available soon on iPhone, Android and Windows phones. Give us your email and we will notify you.</p>
                <br />
                <form id="form1" runat="server">
                    ...
                    <asp:CheckBox ID="CheckBox1" runat="server" TextAlign="Right" Text="You are allowing us to send you india bobbles games & collectibles related emails. We promise that your email address will not be shared with any third party." />
                    <br />
