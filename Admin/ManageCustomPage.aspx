            ...
            <div class="form-vertical">
                    ...
                    <ContentTemplate>
                        <div class="control-group">
                            <label class="control-label" for="<%: NameTextBox.ClientID %>">
                                Page Name</label>
                            <div class="controls">
                                <asp:TextBox CssClass="span12" ID="NameTextBox" CausesValidation="true" MaxLength="200"
                ...
                <div class="control-group">
                    <label class="control-label" for="<%: TitleTextBox.ClientID %>">
                        Page Title</label>
                    <div class="controls">
                        <asp:TextBox CssClass="span12" ID="TitleTextBox" MaxLength="300" runat="server"></asp:TextBox>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:TextBox CssClass="span12" ID="BodyTextBox" TextMode="MultiLine" Rows="20" runat="server"></asp:TextBox>
                ...
                <div class="form-actions">
                    <asp:Button ID="SubmitButton" ValidationGroup="PageGrp" class="btn btn-primary" runat="server"
                        Text="Save n Move" OnClick="SubmitButton_Click" />
                    <asp:Button ID="SubmitStayButton" ValidationGroup="PageGrp" class="btn btn-primary" style="margin-left:10px; margin-right:10px;" runat="server" Text="Save n Stay" OnClick="SubmitStayButton_Click" />
