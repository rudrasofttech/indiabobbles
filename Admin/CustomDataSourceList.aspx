...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString %>"
        ...
        SelectCommand="SELECT CDS.ID, CDS.Name, CDS.DateCreated, CDS.DateModified, CM.MemberName AS CreatedBy, MM.MemberName AS ModifiedBy FROM CustomDataSource AS CDS INNER JOIN Member AS CM ON CDS.CreatedBy = CM.ID LEFT OUTER JOIN Member AS MM ON CDS.ModifiedBy = MM.ID">
    </asp:SqlDataSource>
    <div class="row-fluid">
        <div class="span12">
            <h1>
                Custom Data Sources</h1>
