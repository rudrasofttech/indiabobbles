<%@ Page Title="Site Setting" Language="C#" MasterPageFile="~/Admin/AdminSite.master"
            ...
            <div class="form-horizontal">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="NameReqVal" ValidationGroup="SettingGrp" Display="Dynamic"
                            ControlToValidate="SiteNameTextBox" runat="server" ErrorMessage="Required" CssClass="validate"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="SettingGrp"
                            Display="Dynamic" ControlToValidate="SiteURLTextBox" runat="server" ErrorMessage="Required"
                            CssClass="validate" SetFocusOnError="True"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                ...
                                ValidationGroup="SettingGrp" SetFocusOnError="True"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="SettingGrp"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="SettingGrp"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="SettingGrp"
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Email"
                            ...
                            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="SettingGrp"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="SettingGrp"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="FaxTextBox" class="span6" runat="server" MaxLength="100"></asp:TextBox>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                    ...
                    <div class="controls">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ErrorMessage="Invalid Email"
                            ControlToValidate="ContactTextBox" CssClass="validate" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="SettingGrp" SetFocusOnError="True"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="HeaderTextBox" class="span12" Rows="15" TextMode="MultiLine" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="FooterTextBox" class="span12" Rows="12" TextMode="MultiLine" runat="server"></asp:TextBox>
                    </div>
                </div>
