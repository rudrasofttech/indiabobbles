<%@ Page Title="Footer" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true"
    CodeFile="FooterLink.aspx.cs" Inherits="Admin_FooterLink" %>
        ...
        <div class="span12">
            ...
            <asp:GridView ID="LinkGrid" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ParentID" HeaderText="Parent" SortExpression="ParentID" />
                    <asp:BoundField DataField="Sequence" HeaderText="Sequence" SortExpression="Sequence" />
                    <asp:HyperLinkField DataNavigateUrlFields="ID" 
                        DataNavigateUrlFormatString="footerlink.aspx?id={0}&amp;mode=edit" 
                        Text="Edit" />
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                NavigateUrl='<%# Eval("ID", "footerlink.aspx?id={0}&mode=delete") %>' 
