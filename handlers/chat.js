...
function fetchChatMessage() {
    $.ajax({
        ...
        for (var item in msg.ChatMessages) {
            ...
            cmmbox.append($("<label class='sendername'></label>").html((cm.Name == "Visitor") ? "Me" : cm.Name));
...
$(document).ready(function () {
    ...
    $("#visitChatWindow > #chatWindowTitle").click(function () { $("#visitChatWindow > #chatMessageList").show(); $("#visitChatWindow > #chatInputGroupBox").show(); });
    $("#chatCloseButton").click(function (event) { $("#visitChatWindow > #chatMessageList").hide(); $("#visitChatWindow > #chatInputGroupBox").hide(); event.stopPropagation();});
    fetchChatMessage();
